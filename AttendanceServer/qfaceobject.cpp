...
QFaceObject::QFaceObject(QObject *parent) : QObject(parent)
{
    ...
    //seeta::ModeSetting FDmode("file.dat",seeta::ModelSetting::CPU,0);
    //seeta::ModeSetting PDmode("file.dat",seeta::ModelSetting::CPU,0);
    //seeta::ModeSetting FRmode("file.dat",seeta::ModelSetting::CPU,0);
...
int64_t QFaceObject::face_register(cv::Mat &faceImage)
{
    ...
    //if(faceid >= 0){fengineptr->Save("./file.db");}//人脸注册成功，人脸数据存放进file.db文件
    //return faceid;
}
